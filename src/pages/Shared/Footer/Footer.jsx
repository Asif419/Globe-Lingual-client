...
const Footer = () => {
  return (
    <div>
      <footer className="footer py-10 px-4 md:px-8 lg:px-16 bg-base-200 text-base-content grid grid-cols-1 md:grid-cols-4">
        <div className="justify-self-center lg:justify-self-start justify-items-center lg:justify-items-start">
        ...
        <div className="justify-self-center lg:justify-self-end justify-items-center lg:justify-items-end">
          <span className="footer-title">Legal</span>
          <a className="link link-hover">Terms of use</a>
          <a className="link link-hover">Privacy policy</a>
          <a className="link link-hover">Cookie policy</a>

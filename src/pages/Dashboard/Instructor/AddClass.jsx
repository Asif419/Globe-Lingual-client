...
const AddClass = () => {
      ...
      .then(response => {
        if (response.data.success) {
          ...
          const newClass = {
            ...
            class_photo_url,
            class_price: parseFloat(price),
            total_seats: parseInt(totalSeat),
            enrolled_students: 0,
  ...
  return (
    <>
      <Helmet>
        <title>GlobeLingual | Add Class</title>
      </Helmet>
      <div>
        <Caption heading='Add a Class'></Caption>
        <div className="flex justify-center items-center m-5 md:m-2">
